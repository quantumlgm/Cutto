# Cutto - Сервис сокращения ссылок

Self hosted сервис для сокращения URL адресов и генерации настраиваемых QR-кодов. Проект поддерживает отслеживание кликов в реальном времени с гибридным кешированием `(Redis + PostgreSQL)`, редактор qr-кода для ссылки, автоматический срок действия ссылок по расписанию и кастомные слаги. Полностью контейнеризирован с помощью Docker.
