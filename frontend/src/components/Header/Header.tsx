...
export default function Header() {
  const [activeModal, setActiveModal] = useState<'login' | 'register' | 'links' | null>(null)
        ...
        <div className={s.container}>
          ...
          <nav className={s.nav}>
            <ul className={s.navList}>
              <li>
                <a href="https://t.me/quantumlgm" target="_blank" rel="noopener noreferrer" className={s.navLink}>
                  Contacts
                </a>
              </li>
              <li>
                <a href={`${API_URL}/`} target="_blank" rel="noopener noreferrer" className={s.navLink}>
                  Docs
                </a>
              </li>
              <li>
                <a href="https://github.com/quantumlgm" target="_blank" rel="noopener noreferrer" className={s.navLink}>
                  Github
                </a>
              </li>
            </ul>
          ...
          <div className={s.authButtons}>
            {token ? (
              ...
              <>
                ...
                <Button variant="primary" onClick={() => setActiveModal('register')}>
                  Sign Up
                </Button>
              </>
            )}
          ...
          <div className={s.modalContent}>
            ...
            <form onSubmit={handleLoginSubmit}>
              ...
              <div className={s.formActions}>
                ...
                <button type="button" onClick={() => setActiveModal(null)} className={s.cancelBtn}>Cancel</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className={s.modalContent}>
            <div className={s.modalHeaderInline}>
              ...
              >
                ...
                {sortOrder === 'desc' && <span className={s.sortDirection}>▼</span>}
                {sortOrder === 'asc' && <span className={s.sortDirection}>▲</span>}
              </button>
            </div>
            <div className={s.linksList}>
              {sortedLinks && sortedLinks.length > 0 ? (
                ...
                <div className={s.noLinks}>You haven't shortened any links yet.</div>
              )}
            </div>
            <div className={s.formActions}>
              <button type="button" onClick={() => setActiveModal(null)} className={s.cancelBtn}>
                Close
              </button>
            </div>
          </div>
